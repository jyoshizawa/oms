...
-- 参考
-- https://github.com/dbt-labs/jaffle-sl-template/blob/main/models/marts/customer360/orders.sql
...
order_items_summary as (
    ...
    select
        ...
        count( order_item_id) as order_cost,
        count(order_id) as count_food_items,
        count(1) * 1.0123 as count_drink_items
